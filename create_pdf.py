...
@click.option("--quality", default=None, type=click.IntRange(min=0, max=100), help="Optional JPEG quality for PDF output (0-100). Default uses efficient lossless encoding. Ignored when using --output_images.")
